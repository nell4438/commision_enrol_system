...
$pageTitle = "Manage Yearlevel/Strand";
?>
<!doctype html>
<html lang="en">
  <head>
    <?php include('x-meta.php'); ?>
    <?php include('x-css.php'); ?>
  ...
  <body>
<?php include('x-nav.php'); ?>

<div class="container-fluid">
  <div class="row">
      <?php include('x-sidenav.php'); ?>

    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Manage Yearlevel/Strand</h1>
       
      </div>
      <button type="button" class="btn btn-sm btn-success add">
          Add Year Level/Strand
        </button>
...
<!--modal yearlevel -->
<div class="modal fade" id="yearlevel_modal" tabindex="-1" role="dialog" aria-labelledby="yearlevel_modal_title" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="yearlevel_modal_title">Add Yearlevel/Strand</h5>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.add', function() {
      $('#yearlevel_modal_title').text('Add Yearlevel/Strand');
